...
- [ ] Add an email address to the `ADMINS` settings variable in `boilerplate/boilerplate/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `boilerplate/boilerplate/settings/production.py`
...
- Create a copy of ``boilerplate/settings/local.py.example``:  
  `cp boilerplate/settings/local.py.example boilerplate/settings/local.py` (remembering you should replace `boilerplate` with your project's name!).
